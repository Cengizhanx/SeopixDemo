    ...
    <div class="d-flex flex-column align-items-center gap-2">
        <form class="d-flex flex-wrap align-items-center justify-content-center gap-2 gap-lg-4 px-lg-5 py-lg-2"
            ...
            <div class="col-12 col-md-5 col-lg-4 mb-3">
                ...
                <input type="text" class="form-control" id="name" placeholder="Ad Soyad" name="name" required autofocus
                    autocomplete="name" />
            </div>
            <div class="col-12 col-md-5 col-lg-4 mb-3">
                ...
                <select id="position" name="position" class="form-select" aria-label="Default select example">
                    ...
                    <option value="videoEditor">Video Editörü</option>
                    <option value="projectManager">Proje Yöneticisi</option>
                    <option value="intern">Stajyer</option>
                </select>
            </div>
            <div class="col-12 col-md-5 col-lg-4 mb-3">
                <label for="phone" class="form-label">Telefon</label>
                <input type="number" class="form-control" id="exampleFormControlInput1" placeholder="05..." name="phone"
